...
class CContents extends Component {
    ...
    constructor(){
        super()
        this.state = {msg: 'Witaj użytkowniku. Kliknij przycisk aby poznać wiadomości'}
...
//this.changeMsg = this.changeMsg.bind (this);
    ...
    changeMsg = () =>{
        this.setState({msg: 'właśnie jesteś uczestnikiem kursu React, gratuluje!'});
    ...
    render(){
        ...
        return(
            <div className='contentsDivClass'>
                ...
                <button type="button" onClick={this.changeMsg}> kliknij abby poznać tajemnice</button>
            </div>
        );
    }
}
...
/*
ta wersia działa mimo iż nie powinnw według wykładu 3
<h1> {this.state.msg}</h1>
<button type="button" onClick={this.changeMsg}> kliknij abby poznać tajemnice</button>
    ...
    render(){
        ...
        return(
            <div>
                ...
                <button onClick={this.changeMsg()}> kliknij abby poznać tajemnice</button>
            </div>
        )
    }
}
